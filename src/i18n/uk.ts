...
export const uk: Messages = {
  ...
  dangling: {
    ...
    noteJson:
      "Кожен із цих ключів схожий на посилання — назва, що закінчується на `id`, — але жодна колекція з такою назвою не містить відповідної ідентичності. Або документ не містить другої половини, або ключ узагалі не є посиланням і це прочитання хибне.",
  },
