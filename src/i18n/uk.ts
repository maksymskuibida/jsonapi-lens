...
export const uk: Messages = {
  ...
  dangling: {
    ...
    noteJson:
      "Кожен із цих ключів читається як посилання — назва, що закінчується на `id`, — але під відповідною назвою нічого не знайшлося. Можливо, документ не має другої половини; можливо, назви не збігаються так, як їх зводить це прочитання (`houses` і `house_id` не збігаються); можливо, ключ узагалі не є посиланням.",
  },
